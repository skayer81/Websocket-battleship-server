  ...
  function GamesHandler() {
    ...
    this.addShipsToGame = function (gameId, indexPlayer, ships) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          player =
            (_b =
              (_a = this.games.find(function (game) {
    ...
    this.startGame = function (gameId) {
      return __awaiter(_this, void 0, void 0, function () {
        var game;
        return __generator(this, function (_a) {
          game = this.games.find(function (game) {
            return game.gameId === gameId;
          });
            ...
            case 0:
              ...
              if (
                !(
                  (game === null || game === void 0
                    ? void 0
                    : game.currentPlayer.indexPlayer) === indexPlayer
                )
              )
                return [2];
              ...
              return [
                4,
                this.getAttackResult(this.getShipsOtherPlayer(game), x, y),
              ];
            case 1:
